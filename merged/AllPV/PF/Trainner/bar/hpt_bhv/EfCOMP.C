...
void EfCOMP(){
  ...
  TH1F *Lpts = new TH1F("Lpts","Loose Cut Efficiency pt",100,0,800);
  TH1F *Mpts = new TH1F("Mpts","Medium Cut Efficiency pt",100,0,800);
  TH1F *Tpts = new TH1F("Tpts","Tight Cut Efficiency pt",100,0,800); 
  ...
  TH1F *Lptb = new TH1F("Lptb","Loose Cut b Efficiency pt",100,0,800);
  TH1F *Mptb = new TH1F("Mptb","Medium Cut b Efficiency pt",100,0,800);
  TH1F *Tptb = new TH1F("Tptb","Tight Cut b Efficiency pt",100,0,800); 
  ...
  TH1F *Sieaft  = new TH1F("Sieaft","Sieie cut only",100,0,800); 
  TH1F *ToEaft  = new TH1F("ToEaft","HoE cut only",100,0,800); 
  TH1F *IsoPaft = new TH1F("IsoPaft","IsoP cut only",100,0,800); 
  TH1F *IsoCaft = new TH1F("IsoCaft","IsoC cut only",100,0,800); 
  TH1F *IsoNaft = new TH1F("IsoNaft","IsoN cut only",100,0,800); 
  ...
  Lptr->GetYaxis()->SetRangeUser(0,30.0);
  ...
  Letar->GetYaxis()->SetRangeUser(0,30.0);
  ...
  Lnvtxr->GetYaxis()->SetRangeUser(0,50.0);
  ...
  */
  ...
  TFile *f1 = new TFile("Barrel_Plots.root","recreate");
  f1->cd();
