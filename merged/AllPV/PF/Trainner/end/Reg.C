...
void Reg(){
  ...
  ifstream myfile; 
  myfile.open("/uscms_data/d3/asroy/PhotonIdTuning/CMSSW_7_3_5/src/CutBasedPhoID2016/merged/ChEA_trainner/subset_sample/end/99per.txt");
  ...
  //Output file 
  TString outfileName( "Loose_w_END_scaled.root" );
  ...
  factory->AddVariable( "(isoN-(0.0153*Ppt+0.000016*Ppt*Ppt) > 0 ) ? isoN-(0.0153*Ppt+0.000016*Ppt*Ppt) : 0.0 ",'F' );
  factory->AddVariable( "(isoP-0.0036*Ppt > 0 ) ? isoP-0.0036*Ppt : 0.0 ",'F' );

  //factory->AddVariable( "(isoN-(0.0139*Ppt+0.000025*Ppt*Ppt) > 0 ) ? isoN-(0.0139*Ppt+0.000025*Ppt*Ppt) : 0.0 ",'F' );
  //factory->AddVariable( "(isoP-0.0034*Ppt > 0 ) ? isoP-0.0034*Ppt : 0.0 ",'F' );
  
  factory->AddSpectator( "Ppt",'F' );
  factory->AddSpectator( "ToE",'F' );
  
  TString fname = "/uscms_data/d3/asroy/PhotonIdTuning/CMSSW_7_3_5/src/CutBasedPhoID2016/merged/ChEA_trainner/CutTMVAEndCap90.root";
  ...
  //Just Some more settings
   ...
   // methodOptions +=":VarProp[0]=FMax:VarProp[1]=FMax:VarProp[2]=FMax:VarProp[3]=FMax:VarProp[4]=FMax";
   ...
   //   methodOptions +=":CutRangeMin[3]=-4.0";
