...
void RegM(){
  ...
  ifstream myfile; 
  myfile.open("/uscms_data/d3/asroy/PhotonIdTuning/CMSSW_7_3_5/src/CutBasedPhoID2016/merged/ChEA_trainner/subset_sample/end/LooseR.txt");


  ostringstream xcS,xcP,xcC,xcN;  
  double xS,xC,xN,xP;
