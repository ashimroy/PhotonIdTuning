...
void RegT(){
  ...
  ifstream myfile; 
  myfile.open("/uscms_data/d3/asroy/PhotonIdTuning/CMSSW_7_3_5/src/CutBasedPhoID2016/merged/ChEA_trainner/subset_sample/end/MediumR.txt");
  ...
  //Output file 
  TString outfileName( "Tight_w_END_scaled.root" );
