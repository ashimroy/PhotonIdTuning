...
void Reg(){
  ...
  factory->AddVariable( "(isoP-0.0047*Ppt > 3.0 ) ? isoP-0.0047*Ppt : 3.0 ",'F' );
  ...
  TString fname = "/uscms_data/d3/asroy/PhotonIdTuning/CMSSW_7_3_5/src/CutBasedPhoID2016/merged/TruePV/PF/Trainner/CutTMVABarrel90.root";
  ...
  //Just Some more settings
   ...
   //methodOptions +=":VarProp[0]=FMin:VarProp[1]=FMin:VarProp[2]=FMin";
   ...
   //methodOptions +=":CutRangeMin[3]=2.0";
   //methodOptions +=":CutRangeMin[4]=0.02";
