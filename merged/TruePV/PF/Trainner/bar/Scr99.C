...
void Scr99(){
  ...
  //TFile *f1 = new TFile("/uscms_data/d3/asroy/PhotonIdTuning/CMSSW_7_3_5/src/CutBasedPhoID2016/merged/TruePV/PF/Trainner/CutTMVABarrel90.root");
  ...
  for(int i = 0; i < t_S->GetEntries(); i++){
    ...
    double isoph = TMath::Max(IsoP - 0.0047*Ppt,0.0);
    double isoneu = TMath::Max(IsoN - (0.0148*Ppt+0.000017*Ppt*Ppt),0.0);
