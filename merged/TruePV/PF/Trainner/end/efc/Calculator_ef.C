...
void Calculator_ef(){
  ...
  //Input file:
  TFile *fname = new TFile( "/uscms_data/d3/asroy/PhotonIdTuning/CMSSW_7_3_5/src/CutBasedPhoID2016/merged/AllPV/PF/Trainner/CutTMVAEndCap90.root");
  //TFile *fname = new TFile( "/uscms_data/d3/asroy/PhotonIdTuning/CMSSW_7_3_5/src/CutBasedPhoID2016/merged/TruePV/PF/Trainner/CutTMVAEndCap90.root");   
  //TFile *fname = new TFile( "/uscms_data/d3/asroy/PhotonIdTuning/CMSSW_7_3_5/src/CutBasedPhoID2016/merged/AllPV/PF/Isopt/CutTMVAEndCap90_HPT.root"); 
  ...
  for(int i  = 0 ; i < t_S->GetEntries(); i++){
    ...
    double slopeN = (0.0163*Ppt+0.000014*Ppt*Ppt); 
