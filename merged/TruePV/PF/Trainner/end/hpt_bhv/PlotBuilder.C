...
void PlotBuilder(){
  ...
  //TFile *finput = new TFile( "/uscms_data/d3/asroy/PhotonIdTuning/CMSSW_7_3_5/src/CutBasedPhoID2016/merged/TruePV/PF/Trainner/CutTMVAEndCap90.root");
  ...
  TFile *finput = new TFile( "../../../Isopt/CutTMVAEndCap90_HPT.root");
