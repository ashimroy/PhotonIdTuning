...
void Scr99(){
  ...
  TFile *f1 = new TFile("/uscms_data/d3/asroy/PhotonIdTuning/CMSSW_7_3_5/src/CutBasedPhoID2016/merged/TruePV/PF/Trainner/CutTMVAEndCap90.root");
  ...
  for(int i = 0; i < t_S->GetEntries(); i++){
    ...
    double isoneu = TMath::Max(IsoN - (0.0163*Ppt+0.000014*Ppt*Ppt),0.0);
