void Variables(int reg){
  ...
  if(reg == 1){
    ...
    t_S->Draw("max(isoN-(0.0148*Ppt+0.000017*Ppt*Ppt) , 0.0 )>>hisoN_s(60,0,6)","weighT*(Ppt > 15 && Ppt < 200 && ToE <0.05  )");
    t_S->Draw("max(isoP - 0.0047*Ppt , 0.0 )>>hisoP_s(60,0,6)","weighT*(Ppt > 15 && Ppt < 200  )");
  }else{

    t_S->Draw("Sieie>>hsigm_s(200,0.01,0.05)","weighT*(Ppt > 15 && Ppt < 200  && ToE <0.05  ) ");
 
    t_S->Draw("max(isoN-(0.0163*Ppt+0.000014*Ppt*Ppt), 0.0 )>>hisoN_s(60,0,6)","weighT*(Ppt > 15 && Ppt < 200 && ToE <0.05  )");
  ...
  if(reg == 1){
    ...
    t_B->Draw("max(isoN-(0.0148*Ppt+0.000017*Ppt*Ppt), 0.0 )>>hisoN_b(60,0,6)","weighT*(Ppt > 15 && Ppt < 200 && ToE <0.05  )");
    t_B->Draw("max(isoP - 0.0047*Ppt , 0.0 )>>hisoP_b(60,0,6)","weighT*(Ppt > 15 && Ppt < 200 && ToE <0.05  )");
  }else{

    t_B->Draw("Sieie>>hsigm_b(200,0.01,0.05)","weighT*(Ppt > 15 && Ppt < 200 && ToE <0.05  )");
  
    t_B->Draw("max(isoN-(0.0163*Ppt+0.000014*Ppt*Ppt), 0.0 )>>hisoN_b(60,0,6)","weighT*(Ppt > 15 && Ppt < 200 && ToE < 0.05  )");
