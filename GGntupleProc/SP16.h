...
// Sun May 22 13:35:25 2016 by ROOT version 5.34/18
// from TTree EventTree/Event data
// found on file: /eos/uscms/store/user/maravin/GGNTUPLE/DATA/V08_00_05_00/job_spring16_gjet_pt20_MGG_40to80_miniAOD.root
//////////////////////////////////////////////////////////
...
public :
   ...
   SP16(const char *infile, TTree *tree=0);
   virtual ~SP16();
...
#ifdef SP16_cxx
SP16::SP16(const char *infile, TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
  ...
  if (tree == 0) {
    //TFile *f = TFile::Open("root://cmsxrootd.fnal.gov//store/user/maravin/GGNTUPLE/DATA/V08_00_05_00/job_spring16_gjet_pt20_MGG_40to80_miniAOD.root");
  ...
  Init(tree);
    /*
    TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/uscms/store/user/maravin/GGNTUPLE/DATA/V08_00_05_00/job_spring16_gjet_pt20_MGG_40to80_miniAOD.root");
      if (!f || !f->IsOpen()) {
	f = new TFile("/eos/uscms/store/user/maravin/GGNTUPLE/DATA/V08_00_05_00/job_spring16_gjet_pt20_MGG_40to80_miniAOD.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/eos/uscms/store/user/maravin/GGNTUPLE/DATA/V08_00_05_00/job_spring16_gjet_pt20_MGG_40to80_miniAOD.root:/ggNtuplizer");
      dir->GetObject("EventTree",tree);
...
Int_t SP16::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t SP16::LoadTree(Long64_t entry)
{
